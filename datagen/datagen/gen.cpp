...
int main(int argc, char *argv[]) {
  ...
  std::cerr << "Note that cnpy has a bug preventing saving files that are too large (a few GB). "\
               "Ensure that num_records is not large enough to trigger this. If you want larger "\
               "datasets, consider running this program multiple times with different seeds.";
